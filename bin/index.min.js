...
function usePaypalScript(props) {
  var scriptCache = [];
  var url = Object(_composeUrl__WEBPACK_IMPORTED_MODULE_2__["default"])(props.paypalOptions);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    // if cache is in script set as complete
...
var composeUrl = function composeUrl(options) {
  ...
  var queryParams = Object.keys(options).reduce(function (prevParams, currentValue, index) {
    ...
    // seperate by an '&' symbol except for the first key value pair
